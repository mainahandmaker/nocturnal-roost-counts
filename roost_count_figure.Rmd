...
whim_plot <- function(this_date) {
  ...
  fxn_plot <- ggplot(data = new_df) +
    ...
    # appearance
    theme_bw() +
    theme(axis.text.x = element_text(angle = 40, size = 22, face = "bold", hjust = 1.0, color = rep(c("#63605F", "#FFFFFF"), times = 7)),
...
```{r}
# save 
ggsave("WaderStudy_Fig2_2021-03-11.jpg", all_5_nights, width = 35, height = 18, dpi = 300)
ggsave("WaderStudy_Fig2_2021-03-11_BW.jpg", all_5_nights, width = 35, height = 18, dpi = 300)
```
