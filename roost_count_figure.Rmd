...
whim_plot <- function(this_date) {
  ...
  fxn_plot <- ggplot(data = new_df) +
    ...
    geom_pointrange(x = as_datetime(civ_twi), y = hline_yint_civ_twi, 
                    ymin = hline_yint_civ_twi, ymax = hline_yint_civ_twi,
               color = "#262E43", shape=15, size = 3) +
    geom_pointrange(x = as_datetime(high_tide), y = hline_yint_high_tide,
                    ymin = hline_yint_high_tide, ymax = hline_yint_high_tide,
               color = "#5792CC", shape=17, size = 3) +
...
ggsave("WaderStudy_Fig2a.jpg", all_5_nights, width = 35, height = 18, dpi = 300)
```
