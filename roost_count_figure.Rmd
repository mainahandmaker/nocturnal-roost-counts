...
whim_plot <- function(this_date) {
  ...
  fxn_plot <- ggplot(data = new_df) +
    ...
    scale_fill_manual(name = NULL, 
                      values = c("Whimbrel per \n half-hour interval" = "#BD973D")) +
    # make the breaks on the x-axis 30 minutes
    scale_x_datetime(breaks = scales::date_breaks("30 mins"), minor_breaks = NULL, date_labels = "%H:%M",
    ...
    geom_segment(data = new_df, aes(x = high_tide, xend = high_tide,
                     ...
                     color = "High tide", linetype = "High tide"),
                 size = 1.4, show.legend = FALSE, inherit.aes = FALSE) +
    
    # points on cumulative count line and moon phase icons
    annotate("pointrange", x = as_datetime(civ_twi), y = hline_yint_civ_twi, ymin = hline_yint_civ_twi, ymax = hline_yint_civ_twi, color = "#262E43", size = 0.75) +
    annotate("pointrange", x = as_datetime(high_tide), y = hline_yint_high_tide, ymin = hline_yint_high_tide, ymax = hline_yint_high_tide, color = "#5792CC", size = 0.75) +
    annotation_custom(moon_icon, xmin = as_datetime(paste(this_date, "16:00:00")), xmax = as_datetime(paste(this_date, "17:15:00")), ymin = 16000, ymax = 19000) +
    ...
    scale_color_manual(name = NULL,
                       ...
                       breaks = c("High tide", 
                                  "Civil twilight", "Total cumulative count")) +
    # linetypes for lines
    scale_linetype_manual(name = NULL, 
                          values = c("High tide" = "dotted",
                                     "Civil twilight" = "dotdash",
                                     "Total cumulative count" = "solid"),
                          breaks = c("High tide", "Civil twilight", "Total cumulative count")) +
    
    # appearance
    theme_light() +
    theme(axis.text.x = element_text(angle = 40, size = 22, face = "bold", vjust = 0.7, color = "#63605F"),
          axis.text.y = element_text(size = 24, face = "bold", color = "#63605F"),
          axis.title.x = element_text(size = 24, hjust = 1, color = "#63605F"),
          axis.title.y = element_text(size = 24, hjust = 1, color = "#63605F"),
...
```{r}
# save 
ggsave("WaderStudy_Fig2.jpg", all_5_nights, width = 35, height = 18, dpi = 300)
```
