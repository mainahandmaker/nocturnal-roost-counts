...
#### 4a. Same function but for B&W version of plot for Wader Study print publication
```{r}
whim_plot <- function(this_date) {
  ## pre-plotting
  # datetimes for scale_x_datetime
...
```{r}
# save 
ggsave("WaderStudy_Fig2_2021-03-10.jpg", all_5_nights, width = 35, height = 18, dpi = 300)
ggsave("WaderStudy_Fig2_2021-03-10_BW.jpg", all_5_nights, width = 35, height = 18, dpi = 300)
```
