...
whim_plot <- function(this_date) {
  ...
  fxn_plot <- ggplot(data = new_df) +
    ...
    geom_point(x = as_datetime(civ_twi), y = hline_yint_civ_twi, 
                    #ymin = hline_yint_civ_twi, ymax = hline_yint_civ_twi,
               color = "#262E43", shape = 15, size = 10) +
    geom_point(x = as_datetime(high_tide), y = hline_yint_high_tide,
                    #ymin = hline_yint_high_tide, ymax = hline_yint_high_tide,
               color = "#5792CC", shape = 17, size = 10) +
