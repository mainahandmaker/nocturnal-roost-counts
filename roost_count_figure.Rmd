...
whim_plot <- function(this_date) {
  ...
  fxn_plot <- ggplot(data = new_df) +
    ...
    geom_segment(data = new_df, aes(x = civ_twi, xend = civ_twi,
                 ...
                 size = 2.5, show.legend = FALSE, inherit.aes = FALSE) +
    ...
    annotate("pointrange", x = as_datetime(civ_twi), y = hline_yint_civ_twi, ymin = hline_yint_civ_twi, ymax = hline_yint_civ_twi, color = "#262E43", size = 1) +
    annotate("pointrange", x = as_datetime(high_tide), y = hline_yint_high_tide, ymin = hline_yint_high_tide, ymax = hline_yint_high_tide, color = "#5792CC", size = 1) +
